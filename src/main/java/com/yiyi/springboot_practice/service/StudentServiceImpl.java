...
import com.yiyi.springboot_practice.converter.StudentConverter;
import com.yiyi.springboot_practice.dao.Student;
import com.yiyi.springboot_practice.dao.StudentRepository;
...
public class StudentServiceImpl implements StudentService{
    ...
    public Long addNewStudent(StudentDTO studentDTO) {
        ...
        if (!CollectionUtils.isEmpty(studentList)){
            throw new IllegalStateException("email" + studentDTO.getEmail() + " has been used");
        }
